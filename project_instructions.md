...
dentro /resources trovi file essenziali, da leggere direttaemnte del codice,così da poterli modificare faculemtne e trovarmi le modifiche mnel backend dellapp
teams.csv contiene tutti i team con i relativi coefficienti
puntreggi.csv i relativi punteggi, che per ogni team verranno moltiplicati
partecipanti conteine i nomi dei partecipanti, con le 3 squadre scelte
risultati.csv i risultati di ciascuna squadra, che andranno sommarti e moltiplicati per il loro coefficiente

regolamento.txt ha il regolamento

Ogni èartrecpiante avrà un punteggio dato dalla somma delle sue squadre
L'app deve avere una visualizzazione per la classifica dei partecipanti
